...
exports.default = util_1.createRule({
    ...
    create(context, [{ allowConstantLoopConditions }]) {
        ...
        function checkNode(node) {
            ...
            const messageId = util_1.isTypeFlagSet(type, ts.TypeFlags.Never)
                ? 'never'
        ...
        function checkIfBinaryExpressionIsNecessaryConditional(node) {
            ...
            if (tsutils_1.isStrictCompilerOptionEnabled(compilerOptions, 'strictNullChecks')) {
        ...
        function isOptionableExpression(node) {
            const type = getNodeType(node);
            const isOwnNullable = util_1.isMemberOrOptionalMemberExpression(node)
        ...
        function checkOptionalChain(node, beforeOperator, fix) {
            ...
            const nodeToCheck = node.type === experimental_utils_1.AST_NODE_TYPES.OptionalCallExpression
                ? node.callee
                : node.object;
